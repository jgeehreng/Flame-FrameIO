...
Updates:
    ...
    v2.1.10 02.29.24
        ...
        Added new class:
            PyFlameColorPushButtonMenu - Push Button Menu with color options. Returns selected color as a
...
class OverlayWidget(QtWidgets.QWidget):
    ...
    def paintEvent(self, event):
        painter = QtGui.QPainter(self)
        # Set your line color and thickness
        painter.setPen(QtGui.QPen(QtGui.QColor(0, 110, 176), pyflame.gui_resize(2))) # Blue line 4 pixels thick
        # Draw the line - adjust dimensions as needed
